...
export const Home = () => {
  ...
  return (
    isDesktopOrLaptop ? <div style={{display: "flex", flex: 1, flexDirection: "row", justifyContent: "flex-start"}}>
    <section 
        onScroll={changeView}
        style={{
    ...
    </div> : <div style={{display: "flex", flex: 1, flexDirection: "row", justifyContent: flex}}>
    <section 
        onScroll={changeView}
        style={{
            backgroundImage: `url(${LandingBg})`, 
...
export const DisplayIcon = (props: any) => {
    console.log(props)
    return <div 
    id={props.index}
    onMouseOver={(event) => {
    ...
    onClick={(event) => {
        ...
        const menuClick = new CustomEvent('menuClick',{});
    }}
